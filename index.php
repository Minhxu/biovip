...
<head>
    ...
    <meta name="author" content="MinhXu">
    <meta name="keywords"
    ...
    <meta property="og:url" content="//minhxu.github.io">
...
<body class="BodyStyle">
        ...
        <section class="td-welcome">
            ...
            <div class="infos">
                <div class="logo-web-title">
                    <img class="logo-ws" src="https://i.imgur.com/dxVZLOG.png" alt="Nguyễn Quang Minh">
    ...
    <main id="td-main">
            ...
            <div class="td-popup" id="share_card">
                <div class="left">
                    ...
                    <div class="button mt-2">
                        ...
                        <span class="td-btn"
                            onclick="window.open('https://www.messenger.com/t/' + encodeURIComponent('minhffmax999'),'top');"
        ...
        <section class="td-content">
            <div class="about-me">
                ...
                <div class="avatar">
                    <img class="avatar-img" src="<?=$ThanhDieuHeader->avatar?>?v=<?=rand(1,999)?>" alt="Nguyễn Quang Mimh">
                            ...
                            <div class="nk-opt-set">
                                ...
                                <div class="nk-opt-list">
                                    <ul class="music_menu_list">
                                        <?php foreach ($QuangMinhMusicList->songs as $song): ?>
                                        <li url="<?= $song['url'] ?>">
                                            <span class="name">
    ...
    <footer id="footer">
        <span>
            <a href="//thanhdieu.com" target="_blank">&copy; Copyright&nbsp;QuangMinh 2026</a>
        </span>
    </footer>
